...
export default function BioEnglish() {
  return (
    <article className="bio-copy space-y-6 text-sm">
      ...
      <section className="space-y-2">
        ...
        <ul className="space-y-1 text-slate-100/90">
          ...
          <li className="list-none">• Concertmaster – Chamber Philharmonic Emsland</li>
          <li className="list-none">• Section Leader – Silk Road Symphony Orchestra, Berlin</li>
          <li className="list-none">• I Violin Tutti – Neue Philharmonie Hamburg</li>
          <li className="list-none">• I Violin Tutti – Hansa Philharmonie Hamburg</li>
          <li className="list-none">• Deputy Concertmaster – Neue Philharmonie Berlin</li>
          <li className="list-none">• I Violin Tutti (substitute) – Theater für Niedersachsen, Hildesheim</li>
          <li className="list-none">• I Violin Tutti (substitute) – Deutsches Filmorchester Babelsberg, Berlin</li>
          <li className="list-none">• II Violin Tutti – Russian-German Music Academy, Berlin under Maestro Valery Gergiev</li>
          <li className="list-none">
            • Deputy Concertmaster – Brandenburg Concert Orchestra Eberswalde (fixed-term contract)
          </li>
          <li className="list-none">• Deputy Concertmaster (substitute) – Staatstheater Cottbus</li>
          <li className="list-none">• I Violin Tutti (substitute) – Volkstheater Rostock</li>
          <li className="list-none">• I Violin Tutti (substitute) – Brandenburger Theater</li>
        </ul>
      </section>
    </article>
  );

...
export default function GalleryPage() {
    ...
    return (
        <div className="p-10 min-h-screen sm:min-h-[98.5vh] flex flex-col justify-center items-center">
            ...
            <div className="md:max-w-[30vw] w-full">
                ...
                >
                    {images.map((img) => (
                        <div
                            key={img.id}
                            className="w-full aspect-[3/4] flex justify-center items-center"
                        >
                            <Image
                                src={img.imgurl}
                                alt={img.attribution}
            ...
            {/* Download button */}
            <button className="text-black rounded-full px-4 py-2 bg-gradient-to-r from-yellow-100 via-yellow-150 to-yellow-200 font-mono mt-5">
                {currentLanguage === "e"

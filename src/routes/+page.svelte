...
<div class="min-h-screen sm:min-h-[98.5vh]">
    ...
    <div>
        <h1 class="text-center my-7">bio</h1>
        <Motion
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        >
            <img
                ...
                src="/anait4.jpg"
                alt="somename"
                class="rounded float-left ml-5 mr-3 sm:ml-16 lg:ml-44 lg:mr-6 opacity-0 transition-opacity duration-3000"
                width="180px"
            />
        </Motion>
        <p class="px-5 font-sans pb-10 sm:mx-10 lg:mx-40 text-sm leading-6">
            <span class="italic font-bold">Anait Vanoian</span> wurde 1991 in
            Izmail, Ukraine, geboren. Mit 6 Jahren nahm sie den ersten
            Geigenunterricht.<br />
            Von 1998 bis 2005 war sie Schülerin von T. Spodinetz an der Schule für
            Künste in Kramatorsk, Ukraine.<br />
            Von 2005 bis 2008 besuchte sie bei Professor S. Evdokimov die Spezialmusikschule
            ...
            wo sie zusammen mit dem Komponisten Denys Bocharov eine zeitgenössische
            Komposition von ihm präsentiert hat. Vom 8.- 20.8.2014 spielte sie beim
            Vilalte Musik-Festival in Corsavy, Frankreich, als erste Geigerin in
            unterschiedlichen Besetzungen, in Trios, Quartetts und Sextetts.<br
            /><br />

            2014 und 2015 war sie Stipendiatin des Deutschland-Stipendiums. Sie
            nahm an zahlreichen Meisterkursen teil und spielte dort mit
            führenden Violinisten wie Wladimir Astrachanzew, Aleksej Koshvanets,
            Natalja Boyarskaya, Anatoly Bazhenov, Maxim Rusanow und Thomas
            Brandis, später auch mit Markus Placci und Burghard Maiß, außerdem
            beim Masterkurs mit dem „Aizuri Quartett“ aus Amerika und mit dem
            ersten Violinisten, Martin Funda, des „Armida Quartetts“ Berlin. Ab
            August 2015 ist sie die erste Geigerin des D.U.R.Quartetts in
            Bremen.<br /><br />

            Anait und ihre Kollegen von des D.U.R. Quartett haben Instrumente
            von des berühmten italienischen Geigenbauers Alessandro Ciciliati zu
            bekommen, der Sprechpartner ist „Violin Assets“.<br /><br />

            Ab Oktober 2019 fängte sie als Stellvertreterin Konzertmasterin bei
            „Neue Philharmonie“ Berlin an.<br />
            Berufserfahrung:<br />
            ...
            />
            • II Violine Tutti - Russisch-Deutschen MusikAkademie Berlin unter der
            Leitung Maestro Valery Gergiev<br />
            • Stellvertreterin Konzertmeisterin bei Brandenburgisches Konzertorchester
            Eberswalde (Zeitvertrag)<br />

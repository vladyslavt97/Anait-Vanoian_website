...
{#if navigationState}
    ...
    let:motion
    >
        <div use:motion class="w-screen h-full bg-[#3a3a3a] absolute top-10 left-0 flex flex-col justify-around items-center pb-28 text-white overflow-hidden" on:click={toggleTheNavigation} on:keydown={toggleTheNavigation}>
